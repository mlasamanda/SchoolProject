         ...
         <div class="row">
		    ...
		    <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            ...
		            <textarea class="form-control" style="height:150px" name="type" 
                    placeholder="Detail">{{ $book->type }}</textarea>
		        </div>
		    </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            <strong>Year Publisher:</strong>
		            <input type="text" name="year" value="{{ $book->year }}" class="form-control" placeholder="Name">
		        </div>
		    </div>
